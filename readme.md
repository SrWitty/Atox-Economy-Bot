...
```bash
git clone https://github.com/SrWitty/Economy-Bot.git
```
...
- **CLIENT_ID**: Your Discord bot client ID, also available from the [Discord Developer Portal](https://discord.com/developers).
